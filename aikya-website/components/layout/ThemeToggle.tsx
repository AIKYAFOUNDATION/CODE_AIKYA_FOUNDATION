...
export default function ThemeToggle() {
  ...
  return (
    <button id="THEME-SWITCH"
      ...
      aria-pressed={isDark}
      onClick={handleToggle}
      className="flex h-11 w-11 items-center justify-center rounded-none border-0 bg-transparent shadow-none transition-transform duration-200 cursor-pointer"
    >
      {isDark ? (
